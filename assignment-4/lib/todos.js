...
todosRouter.post("/createTodo", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, text, time;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, title = _a.title, text = _a.text;
                time = Date.now().toString();
                return [4 /*yield*/, db.run("INSERT INTO task VALUES(?, ?, ?, ?, ?)", [null, title, text, time, 0], function (err) {
                        if (err) {
 ...
 */
todosRouter.patch("/updateTodo", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, title, text, completed, updatedTime, ans;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, id = _a.id, title = _a.title, text = _a.text, completed = _a.completed;
                updatedTime = Date.now().toString();
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        db.all("UPDATE task SET title =?, text = ?, \n            last_updated=?, completed=? where id=?", [title, text, updatedTime, completed, id], function (err) {
                            if (err) {
                                console.error(response.status(400).json({ "error": err.message }));
                                return response.status(400).json({ "error": err.message });
                            }
